...
public final class InputSanitizer {
  ...
  /**
   * Return a sanitized JSON string where common sensitive fields (accountNumber, account_name) are
   * masked when present. If parsing fails, returns a short placeholder.
   */
