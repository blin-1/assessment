...
public class TradeProcessorServiceIT {
  ...
  @Autowired private TradeProcessorService service;
  ...
  void processSync_writesCanonicalToCache() throws Exception {
    ...
    SendResult<String, String> mockResult =
        (SendResult<String, String>) Mockito.mock(SendResult.class);
    ...
    @SuppressWarnings("unchecked")
    Map<String, Object> instrMap = mapper.readValue(instrPayload, Map.class);
    assertThat(instrMap.get("platform_id")).isEqualTo("5555444433332222");
    @SuppressWarnings("unchecked")
    Map<String, Object> tradeMap = (Map<String, Object>) instrMap.get("trade");
